...
from . import app
from .db import db
from .forms import AcademicYearForm, TeacherForm, CourseForm, RoomForm, AssignCoursesForm
from .models import AcademicYear, Teacher, Course, Room, TeacherCourse, RoutineSlot
...
# Remove Blueprint and use app.route directly
def register_routes():
    pass
